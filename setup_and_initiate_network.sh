...
# Invoke
docker exec -e "CORE_PEER_LOCALMSPID=RealDirectNSDLMSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/users/Admin@nsdl.realdirect.com/msp" cli peer chaincode invoke -o orderer.realdirect.com:7050 -C realdirectchannel -n realdirect -c '{"function":"initLedger","Args":[]}'